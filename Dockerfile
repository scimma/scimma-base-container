...
RUN yum -y install confluent-community-2.12 \
...
RUN yum -y --disablerepo=* --enablerepo=Confluent.dist --enablerepo=Confluent install librdkafka1.x86_64 librdkafka-devel.x86_64 librdkafka-debuginfo.x86_64
